...
export function SearchChapters({ chapters = 1, value, onChange }: { 
    ...
    <div ref={ref} className={`absolute top-full max-md:left-0 max-md:w-screen dark:bg-neutral-800 bg-neutral-200 transition-all origin-top ${open ? "scale-100" : "scale-0"} rounded-2xl border dark:border-white border-gray-800 overflow-hidden`}>
